...
GLFWwindow* ViewManager::CreateDisplayWindow(const char* windowTitle)
{
	...
	// this callback is used to receive mouse wheel scrolling events////////by Vudeh
	...
	// Assign the created window to the class member variable
	m_pWindow = window;
...
{
	std::cout << "Scroll detected: xOffset = " << xOffset << ", yOffset = " << yOffset << std::endl;
...
void ViewManager::ProcessKeyboardEvents()
{
	...
	// process camera moving upwards
	if (glfwGetKey(m_pWindow, GLFW_KEY_Q) == GLFW_PRESS)
	{
		g_pCamera->ProcessKeyboard(UP, gDeltaTime);
	}

	// process camera moving downwards
